...
tags: ["suninatas"]
cover:
  image: images/posts/suninatas-21/2.png
ShowToc: true
TocOpen: true
---
...
![img](/images/posts/suninatas-21/monitor.jpeg)

위의 이미지가 주어진다.

![img](/images/posts/suninatas-21/1.png)

JPG header인 `FF D8`이 여러 번 검색되는 것을 보아, 문제에서 주어진 이미지의 footer 밑에 또 다른 JPG 파일들이 숨어있다는 것을 추측할 수 있다. binwalk로 추출해보자.

![img](/images/posts/suninatas-21/2.png)

`binwalk --dd='.*' monitor.jpeg`

여러 개의 파일이 추출되었다.

![img](/images/posts/suninatas-21/3.png)

![img](/images/posts/suninatas-21/4.png)
